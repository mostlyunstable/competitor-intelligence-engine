...
URL_PATTERNS: dict[str, list[tuple[str, float]]] = {
    ...
    PageType.SERVICE: [
        ...
        (r"/carpentry", 0.85),
        (r"/ac-repair", 0.85),
        (r"/appliance-repair", 0.85),
        (r"/home-services", 0.85),
        (r"/deep-cleaning", 0.85),
        (r"/sofa-cleaning", 0.85),
        (r"/bathroom-cleaning", 0.85),
        (r"/kitchen-cleaning", 0.85),
    ],
    PageType.PRICING: [
        (r"/pric", 0.95),
        (r"/cost", 0.85),
...
HEADING_KEYWORDS: dict[str, list[tuple[str, float]]] = {
    PageType.SERVICE: [
        ...
        (r"hamari\s+seva", 0.9),
        (r"hum\s+kya\s+karte", 0.85),
        (r"sevaaye", 0.85),
        (r"sevaen", 0.85),
        (r"services?\s+we\s+offer", 0.9),
        (r"home\s+services?", 0.8),
        (r"cleaning\s+services?", 0.85),
        (r"repair\s+services?", 0.85),
        (r"maintenance\s+services?", 0.85),
        (r"plumbing\s+services?", 0.85),
        (r"electrical\s+services?", 0.85),
        (r"pest\s+control", 0.85),
        (r"ac\s+repair", 0.85),
        (r"appliance\s+repair", 0.85),
        (r"beauty\s+services?", 0.85),
        (r"salon\s+services?", 0.85),
        (r"interior\s+design", 0.85),
        (r"modular\s+kitchen", 0.85),
        (r"painting\s+services?", 0.85),
        (r"carpentry\s+services?", 0.85),
    ],
    PageType.PRICING: [
        (r"pricing", 0.95),
        (r"our\s+plan", 0.85),
    ...
    PageType.FAQ: [
        ...
        (r"question", 0.7),
        (r"aam\s+taur\s+par\s+pooche", 0.85),
        (r"prashn", 0.7),
        (r"uttar", 0.6),
    ],
    PageType.CONTACT: [
        ...
        (r"reach\s+us", 0.85),
        (r"sampark\s+kare", 0.9),
        (r"humse\s+sampark", 0.85),
        (r"call\s+us", 0.9),
        (r"hamare\s+sampark", 0.85),
    ],
    PageType.ABOUT: [
        (r"about\s+us", 0.95),
        (r"our\s+story", 0.9),
        ...
        (r"hamare\s+bare", 0.9),
        (r"hamari\s+kahani", 0.85),
        (r"hamari\s+team", 0.85),
        (r"hamara\s+mission", 0.85),
    ],
    PageType.LEGAL: [
